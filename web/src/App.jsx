          ...
          <div className="max-w-4xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="w-full md:w-auto flex flex-col">
              ...
              <div className="text-xs text-slate-500 flex flex-wrap items-center mt-2 gap-y-2">
                ...
                <a href="https://chat.whatsapp.com/C63NIlH1vimLtGCM3pqzbm" target="_blank" rel="noopener noreferrer" className="text-emerald-500 hover:text-emerald-600 font-medium transition-colors flex items-center gap-1 w-full sm:w-auto mt-1 sm:mt-0">
